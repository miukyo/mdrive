...
type Store = {
  getStreamUrl: (messageId: number, folderId?: number | null, peerId?: number | null) => string;
  getThumbnailUrl: (messageId: number, folderId?: number | null, peerId?: number | null) => string;
};

export const useStreamStore = create<Store>()((set) => ({
  getStreamUrl: (messageId: number, folderId?: number | null, peerId?: number | null) => {
  ...
  getThumbnailUrl: (messageId: number, folderId?: number | null, peerId?: number | null) => {
    const { sessionId } = useAuthStore.getState();
